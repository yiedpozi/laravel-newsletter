                ...
                <div class="p-6 bg-white border-b border-gray-200">
                    ...
                    <div class="mt-5 flex">
                        ...
                        @can('delete', $newsletter)
                            <span class="sm:ml-3">
                                <a href="{{ route('user.newsletters.edit', $newsletter->id) }}" class="inline-flex transition items-center rounded-md border border-transparent bg-red-500 px-4 py-2 text-sm font-medium text-white shadow-sm hover:bg-red-600 focus:outline-none focus:ring-2 focus:ring-red-400 focus:ring-offset-2">
